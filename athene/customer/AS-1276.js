...
describe("AS-1276: Reassign Case to Me - Shouldn't require second Search", function () {
	...
	it("VALIDATION for Sellers - 326588332", function () {
        return browser
			//Login to IPM
			.get(url)	
			...
			.elementByCss('form[name=loginForm] input[type=submit]').click()			
			// Initiate OnBoarding for Person Party - Fred Sellers
			...
			.sleep(8000)			
			//Perform Eligibility Review - Select Agent Review
			.frame('TaskShowFrame')
			...
			//Login to IPM - as ComplianceUser1
			...
			//Select radio button and Cancel Close Case
